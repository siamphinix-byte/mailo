            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            <label for="password" class="block text-sm font-medium text-admin-text-secondary">Password (leave blank to keep current)</label>
                            <input
                                type="password"
                                name="password"
                                id="password"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            >
                                @php
                                    $selectedTimezone = (string) old('timezone', $user->timezone);
                                @endphp
