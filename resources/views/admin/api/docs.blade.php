...
<div class="-m-4 sm:-m-6">
    <div id="admin-api-docs" class="min-h-[calc(100vh-10rem)]"></div>
</div>
...
@push('scripts')
    ...
    <script>
        (function () {
            const el = document.getElementById('admin-api-docs');
            if (!el || typeof Scalar === 'undefined') return;

            Scalar.createApiReference('#admin-api-docs', {
                url: '/openapi',
                ...
                customHtml: `
                    ...
                    <tr>
                        <td class="py-2 pr-4 font-mono">GET</td>
                        <td class="py-2 pr-4 font-mono">/api/admin/v1/customers</td>
                        <td class="py-2">{{ __('Admin: list customers (system-wide).') }}</td>
                    </tr>
                `,
            });
        })();
